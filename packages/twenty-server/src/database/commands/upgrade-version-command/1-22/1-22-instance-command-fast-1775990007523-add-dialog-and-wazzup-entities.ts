...
@RegisteredInstanceCommand('1.22.0', 1775990007523)
export class AddDialogAndWazzupEntitiesFastInstanceCommand implements FastInstanceCommand {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('ALTER TYPE "core"."pageLayoutWidget_type_enum" RENAME TO "pageLayoutWidget_type_enum_old"');
    await queryRunner.query('CREATE TYPE "core"."pageLayoutWidget_type_enum" AS ENUM(\'VIEW\', \'IFRAME\', \'FIELD\', \'FIELDS\', \'GRAPH\', \'STANDALONE_RICH_TEXT\', \'TIMELINE\', \'TASKS\', \'NOTES\', \'FILES\', \'EMAILS\', \'CALENDAR\', \'FIELD_RICH_TEXT\', \'WORKFLOW\', \'WORKFLOW_VERSION\', \'WORKFLOW_RUN\', \'FRONT_COMPONENT\', \'RECORD_TABLE\', \'EMAIL_THREAD\', \'DIALOGS\')');
