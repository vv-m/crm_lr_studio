...
import { AddDialogAndWazzupEntitiesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/1-22/1-22-instance-command-fast-1775990007523-add-dialog-and-wazzup-entities';
...
export const INSTANCE_COMMANDS = [
  ...
  AddDialogAndWazzupEntitiesFastInstanceCommand,
];
