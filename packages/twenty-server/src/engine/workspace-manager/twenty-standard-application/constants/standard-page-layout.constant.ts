import {
  ...
  STANDARD_DIALOG_MESSAGE_PAGE_LAYOUT_CONFIG,
  STANDARD_DIALOG_PAGE_LAYOUT_CONFIG,
  STANDARD_DIALOG_TARGET_PAGE_LAYOUT_CONFIG,
  ...
  STANDARD_WAZZUP_ACCOUNT_PAGE_LAYOUT_CONFIG,
  STANDARD_WAZZUP_CHANNEL_PAGE_LAYOUT_CONFIG,
...
export const STANDARD_PAGE_LAYOUTS = {
  ...
  dialogRecordPage: STANDARD_DIALOG_PAGE_LAYOUT_CONFIG,
  dialogMessageRecordPage: STANDARD_DIALOG_MESSAGE_PAGE_LAYOUT_CONFIG,
  dialogTargetRecordPage: STANDARD_DIALOG_TARGET_PAGE_LAYOUT_CONFIG,
  ...
  wazzupAccountRecordPage: STANDARD_WAZZUP_ACCOUNT_PAGE_LAYOUT_CONFIG,
  wazzupChannelRecordPage: STANDARD_WAZZUP_CHANNEL_PAGE_LAYOUT_CONFIG,
