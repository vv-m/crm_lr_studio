...
> => ({
  ...
  accountOwnerForWazzupAccounts: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'accountOwnerForWazzupAccounts',
      label: i18nLabel(msg`Account Owner For Wazzup Accounts`),
      description: i18nLabel(msg`Account owner for Wazzup accounts`),
      icon: 'IconUserCircle',
      isNullable: false,
      isUIReadOnly: true,
